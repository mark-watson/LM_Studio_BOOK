...
google/gemma-4-e2b                         gemma4         3.86 GB  ✓ LOADED
...
Loading model "google/gemma-4-e2b"...
Model loaded successfully in 13.59s. (3.86 GB)
To use the model in the API/SDK, use the identifier "google/gemma-4-e2b:2".
